    ...
    <div className="fea2-body bg-white min-h-screen">
      ...
      <div className="fea-content px-[35px] font-epilogue text-justify mt-[20px] text-black sm:text-[20px] pb-[50px]">
        ...
        <h2 className="mt-[20px]">
          <span className="font-bold">Jakarta, 27 November 2023</span> - Apakah kamu seorang generasi muda yang bersemangat, suka cari cuan, atau ingin menjadi seseorang yang sukses? Inilah saatnya untuk bergabung dengan keluarga Es Teh
          S.O.L.O dan rasakan manisnya kesuksesan di dunia bisnis minuman!
        </h2>
        <h2 className="mt-[20px] font-semibold">Mengapa Es Teh S.O.L.O?</h2>
        <h2 className="mt-[20px] ml-[20px] font-semibold">1. Inovasi dalam Setiap Tetes</h2>
        <h2 className="mt-[20px]">
        ...
        <h2 className="mt-[20px] ml-[20px] font-semibold">2. Dukungan Kemitraan yang Tak Tertandingi</h2>
        <h2 className="mt-[20px]">
        ...
        <h2 className="mt-[20px] ml-[20px] font-semibold">3. Pasar yang Tak Terbatas</h2>
        <h2 className="mt-[20px]">
        ...
        <h2 className="mt-[20px] ml-[20px] font-semibold">4. Keuntungan Finansial yang Menggiurkan</h2>
        <h2 className="mt-[20px]">
