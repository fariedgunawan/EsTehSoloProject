    ...
    <div className="fea2-body bg-white min-h-screen">
      ...
      <div className="fea-content px-[35px] font-epilogue text-justify mt-[20px] text-black sm:text-[20px]">
        ...
        <h2 className="mt-[20px]">
          Jakarta, 29 November 2023 - Di tengah panasnya hari di Indonesia, nggak ada yang lebih menyegarkan daripada menikmati segelas teh dari Es Teh S.O.L.O. Salah satu varian yang khas dari brand Es Teh S.O.L.O yang wajib kamu coba
          adalah Es Teh Kampoel. Meskipun sekilas terlihat mirip, tetapi Es Teh Kampoel dengan Lemon Tea berbeda loh.
        </h2>
        <h2 className="mt-[20px]">
        ...
        <h2 className="mt-[20px]">
          Apa sih yang membuat Es Teh Kampoel begitu istimewa? Pertama-tama, ada cita rasa yang khas dari teh asli. Di setiap tegukannya, kamu akan merasakan cita rasa teh yang pekat dan autentik. Namun, yang membuatnya benar-benar menonjol
          adalah perpaduan rasa manis yang pas dari gula pasir dan madu. Rasanya begitu seimbang, tidak terlalu manis, tetapi cukup untuk memberikan sentuhan manis yang memanjakan lidah.
        </h2>
        <h2 className="mt-[20px]">
