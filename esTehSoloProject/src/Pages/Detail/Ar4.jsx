    ...
    <div className="fea2-body bg-white min-h-screen">
      ...
      <div className="fea-content px-[35px] font-epilogue text-justify mt-[20px] text-black sm:text-[20px] pb-[50px]">
        ...
        <h2 className="mt-[20px]">
          <span className="font-bold">Jakarta, 28 November 2023</span> - Es Teh S.O.L.O adalah merek minuman teh di bawah naungan PT. Esok Harapan Bangsa yang memiliki beragam varian. Dengan variasi menunya, Es Teh S.O.L.O menawarkan
          kombinasi sempurna antara rasa, kualitas, dan manfaat kesehatan. Dalam artikel ini, kami akan membahas manfaat minum teh untukmu sebagai berikut.
        </h2>
        ...
        <h2 className="mt-[20px]">
          Antioksidan dalam teh juga dapat membantu melawan pertumbuhan sel kanker. Beberapa jenis teh, seperti teh hijau, telah dikaitkan dengan pengurangan risiko beberapa jenis kanker. Hal ini dikarenakan kandungan{" "}
          <span className="italic">epigallocatechin gallate</span> (EGCG) yang terdapat dalam teh.
        </h2>
        ...
        <h2 className="mt-[20px]">
          Manfaat teh untuk kesehatan tidak hanya dari segi fisik melainkan dapat juga menjaga suasana hati dan pikiran kita. Teh mengandung asam amino bernama <span className="italic">L-teanin</span> yang dapat membantu meredakan stres dan
          meningkatkan konsentrasi. Sehingga dalam hal ini teh memberikan efek yang dapat merelaksasi tubuh dan membuat rasa tenang selama situasi stres.
        </h2>
        <h2 className="mt-[20px] ml-[20px] font-semibold">6. Meningkatkan Kesehatan Kulit</h2>
        <h2 className="mt-[20px]">
          Antioksidan dalam teh dapat membantu menjaga kulit tetap sehat, bersinar dan mencegah penuaan dini. Dalam teh juga mengandung antioksidan <span className="italic">katekin</span> dan <span className="italic">polifenol</span> yang
          dikenal dapat membantu mengecilkan pembuluh darah di bawah kulit sehingga dapat melawan jerawat. Selain itu, kandungan anti-inflamasi dalam teh juga berperan dalam mengurangi kemerahan dan iritasi kulit, memberikan penampilan yang
        ...
        <div className="img flex flex-col items-center mt-[20px]">
          <img src={artikel4} className="w-[450px] sm:w-[500px]" alt="" />
