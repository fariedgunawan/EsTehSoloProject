        ...
        <div className="company-caption flex flex-col items-center sm:flex-row sm:justify-between sm:gap-[100px]">
          ...
          <div className="caption flex-col flex items-center sm:items-start">
            ...
            <h2 className="text-center mt-[20px] sm:text-left sm:text-[20px]">
              Yakamu Boba adalah merek minuman boba yang menawarkan berbagai varian rasa, termasuk Ovaltine, Taro, Original Brown Sugar, dan Binggan Brown Sugar. Produk kami meliputi minuman dengan tambahan susu creamer, susu full cream,
              Oreo, gula aren, boba, dan toping cheese cream dengan harga sekitar 18.000 rupiah.
            </h2>
          </div>
        </div>
