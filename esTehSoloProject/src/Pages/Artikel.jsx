  ...
  return (
    <div className="artikel-body bg-white min-h-screen font-epilogue text-black">
      ...
      <div className="artikel-bag1 px-[35px] flex justify-center mt-[20px]">
        <div className="bag1-1 flex flex-col w-[300px] sm:w-[450px] px-[20px] py-[10px] shadow-xl rounded-xl">
      ...
      <div className="bag-2-container flex justify-center">
        <div className="artikel-bag2 px-[35px] flex flex-wrap justify-center mt-[20px] gap-[50px] sm:gap-[100px]">
          <div className="bag1-1 flex flex-col w-[300px] sm:w-[450px] px-[20px] py-[10px] shadow-xl rounded-xl" onClick={() => navigate("/feature1")}>
          ...
          <div className="bag1-1 flex flex-col w-[300px] sm:w-[450px] px-[20px] py-[10px] shadow-xl rounded-xl" onClick={() => navigate("/feature2")}>
      ...
      <div className="bag-3-container flex justify-center">
        <div className="artikel-bag3 px-[35px] flex flex-wrap justify-center mt-[20px] gap-[50px] sm:gap-[30px]">
          <div className="bag1-1 flex flex-col w-[300px] sm:w-[450px] px-[20px] py-[10px] shadow-xl rounded-xl" onClick={() => navigate("/artikel1")}>
          ...
          <div className="bag1-1 flex flex-col w-[300px] sm:w-[450px] px-[20px] py-[10px] shadow-xl rounded-xl" onClick={() => navigate("/artikel2")}>
          ...
          <div className="bag1-1 flex flex-col w-[300px] sm:w-[450px] px-[20px] py-[10px] shadow-xl rounded-xl" onClick={() => navigate("/artikel3")}>
